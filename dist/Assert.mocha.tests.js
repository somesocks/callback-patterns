...
describe('Assert', function () {
    it('Assert', (0, InSeries_1.default)(function (next) { return next(null, true); }, (0, Assert_1.default)(function (arg) { return (0, isBoolean_1.default)(arg); })));
    var LONG_CHAIN = InSeries_1.default.apply(void 0, Array(100000).fill((0, Assert_1.default)(function (val) { return val > 0; })));
    ...
    it('re-throws error', (0, InSeries_1.default)((0, CatchError_1.default)((0, Assert_1.default)(function () { return false; }, // always fail,
    function () {
        var err = new Error('foo');
        err.foo = true;
        return err;
    })), (0, Assert_1.default)(function (error) { return error.foo === true; }, 'incorrect error re-thrown')));
});
