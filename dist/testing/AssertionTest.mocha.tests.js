...
var SetupTest = (0, AssertionTest_1.default)()
    ...
    .build();
var SetupErrorTest = (0, AssertionTest_1.default)()
    ...
    .build();
var SetupErrorTest2 = (0, AssertionTest_1.default)()
    .describe('(thrown) error in setup is caught')
    .setup(function (next) { return next(new Error('foo')); })
    .verify(function (next, context) { return next(context.error && context.error.message === 'foo' ? null : new Error('bad setup')); })
    .build();
var PrepareErrorTest = (0, AssertionTest_1.default)()
    ...
    .verify(function (next, context) { return next(context.error && context.error.message === 'foo' ? null : new Error('bad setup')); })
    .build();
var PrepareErrorTest2 = (0, AssertionTest_1.default)()
    ...
    .verify(function (next, context) { return next(context.error && context.error.message === 'foo' ? null : new Error('bad setup')); })
    .build();
var ExecuteErrorTest = (0, AssertionTest_1.default)()
    ...
    .verify(function (next, context) { return next(context.error && context.error.message === 'foo' ? null : new Error('bad setup')); })
    .build();
var ExecuteErrorTest2 = (0, AssertionTest_1.default)()
...
function (next, _a) {
    ...
    return next(result !== true ? new Error("could not ping host ".concat(request)) : null);
})
    .teardown(
// nothing to teardown
...
describe('AssertionTest', function () {
    TESTS.forEach(function (test, i) { return it(test.label || "test ".concat(i), test); });
});
